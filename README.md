...
- [media-crawler-easy](https://github.com/isheng-eqi/media-crawler-easy) - Collect public comments from Bilibili, Xiaohongshu, Douyin, Kuaishou, Weibo, Tieba and Zhihu inside Claude Code, then produce an interactive HTML report with CSV/JSONL data. The agent handles configuration, environment checks and QR-login monitoring. *By [@isheng-eqi](https://github.com/isheng-eqi)*
